  ...
  return (
    <div className={`flex min-h-screen flex-col items-center justify-center px-4 py-16 transition-colors ${
      ...
      <div className="w-full max-w-3xl text-center">
        {/* Logo */}
        <div className="mx-auto mb-6 flex h-[72px] w-[72px] items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 shadow-lg shadow-blue-500/20">
