...
export function createMockClient(): MockClient {
  const store: MockStore = {
    ...
    plans: [
      {
        id: '8aa4c9f7-9e28-4289-a209-8f67d54e31f2',
        name: 'free',
        display_name: 'Free',
        price_cents: 0,
        ...
        limits: {
          billing: false, ical_sync: false, max_students: 10,
          storage_bytes: 104857600, auto_invoicing: false,
          makeup_credits: false, stripe_payments: false,
          broadcasts_per_month: 0,
        },
        features: [
          'Up to 10 students', 'Scheduling & calendar', 'Group lessons',
          'Basic attendance', 'Direct messaging',
          'Student portal with gamification', 'Lesson notes & assignments',
          'Practice logging', 'CSV export', '100 MB file storage',
        ],
        is_active: true,
      },
      {
        ...
        features: [
          'Unlimited students', 'iCal/Google Calendar sync',
          'Unlimited broadcasts', 'Flexible billing',
          'Stripe online payments', 'Auto-invoicing',
          '10 GB file storage', 'Makeup credits', 'Priority support',
        ],
        is_active: true,
      },
    ],
      ...
      switch (fn) {
        case 'get_my_effective_subscription':
          return [{
            id: 'sub-free',
            user_id: USER_ID,
            plan_id: '8aa4c9f7-9e28-4289-a209-8f67d54e31f2',
            status: 'active',
